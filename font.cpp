...
FONT capFont1;		//サンプルのフォント(フォントファイルから読み込んだフォント)
FONT ffFont1;		//サンプルのフォント(フォントファイルから読み込んだフォント)
...
VOID FontDelete(VOID)
{
	...
	DeleteFontToHandle(capFont1.handle);	//サンプルフォント削除
	DeleteFontToHandle(ffFont1.handle);	//サンプルフォント削除
